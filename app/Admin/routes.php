...
Route::group([
	...
	$router->get('demo/api/world/cities', 'World\ApiController@cities');
	$router->get('demo/api/world/countries', 'World\ApiController@countries');
	$router->get('demo/api/china/city', 'China\ChinaController@city');
	$router->get('demo/api/china/district', 'China\ChinaController@district');

	$router->get('widgets/form-1', 'FormController@form1');
	$router->get('widgets/form-2', 'FormController@form2');
	$router->get('widgets/form-3', 'FormController@form3');
	$router->get('widgets/form-4', 'FormController@form4');
